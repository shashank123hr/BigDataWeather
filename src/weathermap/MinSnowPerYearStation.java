...
public class MinSnowPerYearStation 
{
                ...
                DoubleWritable> output, Reporter reporter) throws IOException 
	{
            ...
            String temperatureValueRead = line.substring(321, 327).trim();
            
            // Ignoring the first value as its the heading
            if(!temperatureValueRead.equals("") && 
                    !temperatureValueRead.equals("EMXP"))
            {
    ...
    {      
        JobConf jobConfiguration = new JobConf(MinSnowPerYearStation.class);
