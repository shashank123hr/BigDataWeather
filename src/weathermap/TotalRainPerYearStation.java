...
public class TotalRainPerYearStation 
{
                ...
                DoubleWritable> output, Reporter reporter) throws IOException 
	{
            ...
            double windSpeed = 0;
            String windSpeedValueRead = line.substring(339, 345).trim();
            
            // Ignoring the first value as its the heading
            if(!windSpeedValueRead.equals("") && 
                    !windSpeedValueRead.equals("TPCP"))
            {
    ...
    {      
        JobConf jobConfiguration = new JobConf(TotalRainPerYearStation.class);
