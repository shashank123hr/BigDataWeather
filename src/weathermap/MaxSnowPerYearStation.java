...
public class MaxSnowPerYearStation 
{
                ...
                DoubleWritable> output, Reporter reporter) throws IOException 
	{
            ...
            double windSpeed = 0;
            String windSpeedValueRead = line.substring(321, 327).trim();
    ...
    {      
        JobConf jobConfiguration = new JobConf(MaxSnowPerYearStation.class);
