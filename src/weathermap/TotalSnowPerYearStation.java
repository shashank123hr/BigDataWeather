...
public class TotalSnowPerYearStation 
{
                ...
                DoubleWritable> output, Reporter reporter) throws IOException 
	{
            ...
            double windSpeed = 0;
            String windSpeedValueRead = line.substring(348, 354).trim();
            
            // Ignoring the first value as its the heading
            if(!windSpeedValueRead.equals("") && 
                    !windSpeedValueRead.equals("MXSD"))
            {
    ...
    {      
        JobConf jobConfiguration = new JobConf(TotalSnowPerYearStation.class);
