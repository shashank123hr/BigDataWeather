...
public class DailySnowInAllStations 
{
                ...
                DoubleWritable> output, Reporter reporter) throws IOException 
	{
            ...
            String station = line.substring(11, 18).trim();
            String year = line.substring(71, 78).trim();
            double windSpeed = 0;
    ...
    {      
        JobConf jobConfiguration = new JobConf(DailySnowInAllStations.class);
